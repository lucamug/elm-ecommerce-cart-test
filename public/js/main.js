...
var _user$project$Cart_Types$Product = F6(
	function (a, b, c, d, e, f) {
		return {id: a, description: b, pictureURL: c, name: d, price: e, isInStock: f};
	});
var _user$project$Cart_Types$Customization = F2(
	function (a, b) {
		return {email: a, quantity: b};
	});
var _user$project$Cart_Types$Item = F3(
	function (a, b, c) {
		return {product: a, quantity: b, customization: c};
	});
var _user$project$Cart_Types$Cart = function (a) {
	return {items: a};
};
var _user$project$Cart_Types$Purchase = function (a) {
	return {items: a};
};
var _user$project$Cart_Types$Model = F6(
	function (a, b, c, d, e, f) {
		return {cart: a, availableProducts: b, page: c, purchaseInProgress: d, currentProduct: e, currentCustomization: f};
	});
var _user$project$Cart_Types$CheckoutSuccess = {ctor: 'CheckoutSuccess'};
var _user$project$Cart_Types$Checkout = {ctor: 'Checkout'};
var _user$project$Cart_Types$ProductDetail = {ctor: 'ProductDetail'};
var _user$project$Cart_Types$ProductList = {ctor: 'ProductList'};
var _user$project$Cart_Types$PurchaseFail = function (a) {
	return {ctor: 'PurchaseFail', _0: a};
};
var _user$project$Cart_Types$PurchaseSucceed = function (a) {
	return {ctor: 'PurchaseSucceed', _0: a};
};
var _user$project$Cart_Types$Customize = function (a) {
	return {ctor: 'Customize', _0: a};
};
var _user$project$Cart_Types$GoHome = {ctor: 'GoHome'};
var _user$project$Cart_Types$SelectProduct = function (a) {
	return {ctor: 'SelectProduct', _0: a};
};
var _user$project$Cart_Types$StartPurchase = function (a) {
	return {ctor: 'StartPurchase', _0: a};
};
var _user$project$Cart_Types$StartCheckout = {ctor: 'StartCheckout'};
var _user$project$Cart_Types$RemoveItem = function (a) {
	return {ctor: 'RemoveItem', _0: a};
};
var _user$project$Cart_Types$UpdateItemQuantity = F2(
	function (a, b) {
		return {ctor: 'UpdateItemQuantity', _0: a, _1: b};
	});
var _user$project$Cart_Types$AddToCart = F2(
	function (a, b) {
		return {ctor: 'AddToCart', _0: a, _1: b};
	});

var _user$project$Cart_Http$postPurchase = function (purchase) {
	var response = {
		data: '',
		status: 200,
		statusText: '',
		headers: _elm_lang$core$Dict$fromList(
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: '', _1: ''}
				])),
	...
	var task = A2(
		...
		function (n) {
			return _elm_lang$core$Task$succeed(response);
		});
	return A3(_elm_lang$core$Task$perform, _user$project$Cart_Types$PurchaseFail, _user$project$Cart_Types$PurchaseSucceed, task);
};
var _user$project$Cart_Http$postItems = function (purchase) {
	var items = A2(
		_elm_lang$core$List$map,
		function (item) {
			return _elm_lang$core$Json_Encode$object(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'id',
						_1: _elm_lang$core$Json_Encode$string(item.product.id)
					},
						{
						ctor: '_Tuple2',
						_0: 'quantity',
						...
						_1: _elm_lang$core$Json_Encode$string(
							A2(_elm_lang$core$Maybe$withDefault, '', item.customization.email))
					}
					]));
		},
		purchase.items);
	var body = _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'items',
			_1: _elm_lang$core$Json_Encode$list(items)
		}
		]);
	var request = A3(
		...
		A3(
			...
			A2(
				...
				_elm_lang$core$Json_Encode$object(body),
				_lukewestby$elm_http_builder$HttpBuilder$post('/api/purchases'))));
	return A3(_elm_lang$core$Task$perform, _user$project$Cart_Types$PurchaseFail, _user$project$Cart_Types$PurchaseSucceed, request);
};

var _user$project$Cart_State$addToCart = F3(
	function (cart, product, customization) {
		var quantity = A2(_elm_lang$core$Maybe$withDefault, 1, customization.quantity);
		var updatedItems = A2(
			_elm_lang$core$List$append,
			cart.items,
			_elm_lang$core$Native_List.fromArray(
				[
					A3(_user$project$Cart_Types$Item, product, quantity, customization)
				]));
		return _elm_lang$core$Native_Utils.update(
			cart,
			{
				items: A2(_elm_lang$core$Debug$log, 'updated cart items', updatedItems)
			});
	});
var _user$project$Cart_State$increaseItemQuantityForProduct = F2(
	function (items, product) {
		var increaseQuantity = function (item) {
			return _elm_lang$core$Native_Utils.eq(item.product.id, product.id) ? _elm_lang$core$Native_Utils.update(
				item,
				{quantity: item.quantity + 1}) : item;
		};
		return A2(_elm_lang$core$List$map, increaseQuantity, items);
	});
var _user$project$Cart_State$isSameItem = F2(
	function (item1, item2) {
		return _elm_lang$core$Native_Utils.eq(item1.product.id, item2.product.id) && _elm_lang$core$Native_Utils.eq(item1.customization, item2.customization);
	});
var _user$project$Cart_State$updateItemQuantity = F3(
	function (cart, itemToUpdate, quantity) {
		var updatedItems = A2(
			_elm_lang$core$List$filterMap,
			function (item) {
				return A2(_user$project$Cart_State$isSameItem, item, itemToUpdate) ? (_elm_lang$core$Native_Utils.eq(quantity, 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
					_elm_lang$core$Native_Utils.update(
						item,
						{quantity: quantity}))) : _elm_lang$core$Maybe$Just(item);
			},
			cart.items);
		return _elm_lang$core$Native_Utils.update(
			cart,
...
var _user$project$Cart_State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'AddToCart':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{
						cart: A3(_user$project$Cart_State$addToCart, model.cart, _p0._0, _p0._1),
						page: _user$project$Cart_Types$Checkout
					});
			...
			case 'UpdateItemQuantity':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{
						cart: A3(_user$project$Cart_State$updateItemQuantity, model.cart, _p0._0, _p0._1)
					});
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'RemoveItem':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{
						cart: A3(_user$project$Cart_State$updateItemQuantity, model.cart, _p0._0, 0)
					});
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'StartCheckout':
				var model = _elm_lang$core$Native_Utils.update(
			...
			case 'SelectProduct':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{
						currentProduct: _elm_lang$core$Maybe$Just(_p0._0),
						page: _user$project$Cart_Types$ProductDetail
					});
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'GoHome':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{currentProduct: _elm_lang$core$Maybe$Nothing, currentCustomization: _elm_lang$core$Maybe$Nothing, page: _user$project$Cart_Types$ProductList});
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Customize':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{
						currentCustomization: _elm_lang$core$Maybe$Just(_p0._0)
					});
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'StartPurchase':
				var purchase = _user$project$Cart_Types$Purchase(_p0._0.items);
				var command = _user$project$Cart_Http$postPurchase(purchase);
				var model = _elm_lang$core$Native_Utils.update(
					model,
			...
			case 'PurchaseSucceed':
				var model = _elm_lang$core$Native_Utils.update(
					model,
					{
						...
						page: _user$project$Cart_Types$CheckoutSuccess,
						cart: _user$project$Cart_Types$Cart(
							_elm_lang$core$Native_List.fromArray(
								[]))
					});
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Cart_State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Cart_State$availableProducts = _elm_lang$core$Native_List.fromArray(
	[
		A6(
		_user$project$Cart_Types$Product,
		'1',
		'Free Delivery',
		_elm_lang$core$Maybe$Just('http://files.rakuten-static.de/789653a5d4e1d8bf4e00a151560691bf/thumbs/280/11/103cbe07d8e08f72bee5c25b1f243315/r760r770-gear-s3-smartwatch.jpg'),
		...
		'2',
		'Free Delivery',
		_elm_lang$core$Maybe$Just('http://files.rakuten-static.de/a80a984051650024bc9aba3c601fb83a/thumbs/280/8a/0bd461750bf5d2a3b76049c13e2ad088/4-st-und-uumlck-klappsessel-sessel-klappstuhl-santos-natur.jpg'),
		'Folding Chair',
		189.95,
		true),
		A6(
		...
		'3',
		'Free Delivery',
		_elm_lang$core$Maybe$Just('http://files.rakuten-static.de/9b29a711b743e15206bc41bcc7604b50/thumbs/280/57/733d7d6c4458e093ca91b707bc17a835/5ksm7591xeer-heavy-duty-k-und-uumlchenmaschine-500w-6-9l-empire-rot.jpg'),
		'KitchenAid 5KSM7591',
		579,
		true),
		A6(
		...
		'4',
		'Free Delivery',
		_elm_lang$core$Maybe$Just('http://files.rakuten-static.de/e9d9152203630452fef5a10bdbe6f01b/thumbs/280/2d/c4494d84e489e8022313b5190a8cf0c5/likeabike-jumper-von-kokua-like-a-bike-orange.jpg'),
		'KOKUA LIKEaBIKE',
		194.96,
		true),
		A6(
		...
		'5',
		'Free Delivery',
		_elm_lang$core$Maybe$Just('http://files.rakuten-static.de/3ab313888b4d55bc32195930a0a00cfe/thumbs/280/3d/1228f1a814c0532816be9038e1994b2f/chefsessel-buerostuhl-drehstuhl-basel-kunstleder-schwarz.jpg'),
		'Office Chair, Basel',
		94.99,
		true),
		A6(
		...
		'6',
		'Free Delivery',
		_elm_lang$core$Maybe$Just('http://files.rakuten-static.de/5ed78c0b121753b6d5b6de4dbd792a34/thumbs/280/2f/1b13682d0df545fb3c949a9216722fc7/fritzbox-7490-breitbandrouter-mit-bis-zu-450-mbits-und-ipv6-unterst-und-uumltzung.jpg'),
		'AVM FRITZ! Box 7490',
		189.9,
		true)
	]);
var _user$project$Cart_State$init = function () {
	var command = _elm_lang$core$Platform_Cmd$none;
	var model = A6(
		_user$project$Cart_Types$Model,
		_user$project$Cart_Types$Cart(
			_elm_lang$core$Native_List.fromArray(
				[])),
		_user$project$Cart_State$availableProducts,
		_user$project$Cart_Types$ProductList,
		false,
		_elm_lang$core$Maybe$Nothing,
		_elm_lang$core$Maybe$Nothing);
	return {ctor: '_Tuple2', _0: model, _1: command};
...
var _user$project$Cart_View$footerView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-footer')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('made with elm'),
				A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$Cart_Types$GoHome),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-header-checkout cart'),
						_elm_lang$html$Html_Events$onClick(_user$project$Cart_Types$StartCheckout),
						_elm_lang$html$Html_Attributes$href('#')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-header-number')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(
							_elm_lang$core$List$length(model.cart.items)))
					]))
			]));
};
var _user$project$Cart_View$customizationFormView = F2(
	function (product, customization) {
		var parseQuantity = function (quantity) {
			var _p0 = _elm_lang$core$String$toInt(quantity);
			if (_p0.ctor === 'Ok') {
				return _elm_lang$core$Maybe$Just(_p0._0);
			} else {
				return _elm_lang$core$Maybe$Nothing;
		...
		var quantityValue = function () {
			var _p1 = customization.quantity;
			if (_p1.ctor === 'Nothing') {
				return '';
			} else {
		...
		var email = A2(_elm_lang$core$Maybe$withDefault, '', customization.email);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('elm-cart-product-customization')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$value(email),
									_elm_lang$html$Html_Events$onInput(
									function (email) {
										return _user$project$Cart_Types$Customize(
											A2(
												_user$project$Cart_Types$Customization,
												_elm_lang$core$Maybe$Just(email),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$value(quantityValue),
									_elm_lang$html$Html_Attributes$type$('number'),
									_elm_lang$html$Html_Attributes$pattern('\\d*'),
									_elm_lang$html$Html_Events$onInput(
									function (quantity) {
										return _user$project$Cart_Types$Customize(
											A2(
...
var _user$project$Cart_View$productDescriptionView = function (product) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-product-detail-description')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Cart_View$getCurrentCustomization = function (model) {
	var _p2 = model.currentCustomization;
	if (_p2.ctor === 'Just') {
		return _p2._0;
	} else {
		return A2(
...
var _user$project$Cart_View$postCheckoutView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-postcheckout')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Enjoy your Purchase!')
					])),
				A2(
				_elm_lang$html$Html$img,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-postcheckout-image'),
						_elm_lang$html$Html_Attributes$src('img/delivery.gif')
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$href('#'),
						_elm_lang$html$Html_Events$onClick(_user$project$Cart_Types$GoHome),
						_elm_lang$html$Html_Attributes$class('elm-cart-button')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('I want to buy more!')
					]))
			]));
};
var _user$project$Cart_View$purchaseView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-purchase')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-button'),
						_elm_lang$html$Html_Attributes$disabled(model.purchaseInProgress),
						_elm_lang$html$Html_Events$onClick(
						_user$project$Cart_Types$StartPurchase(model.cart))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Checkout')
					]))
			]));
};
var _user$project$Cart_View$loaderView = function (model) {
	var _p3 = model.purchaseInProgress;
	if (_p3 === true) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('elm-cart-loader'),
							_elm_lang$html$Html_Attributes$src('img/loader.gif')
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
				]));
...
var _user$project$Cart_View$formatCurrency = function (amount) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_ggb$numeral_elm$Numeral$format, '0,00.00', amount),
		' €');
};
var _user$project$Cart_View$totalView = function (model) {
	var total = _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
			function (item) {
				return item.product.price * _elm_lang$core$Basics$toFloat(item.quantity);
			},
			model.cart.items));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-sc-total')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-sc-total-text')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-sc-total-number')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_user$project$Cart_View$formatCurrency(total))
					]))
			]));
};
var _user$project$Cart_View$shoppingCartRemoveItemView = function (item) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-sc-item-remove'),
				_elm_lang$html$Html_Events$onClick(
				_user$project$Cart_Types$RemoveItem(item))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
...
var _user$project$Cart_View$shoppingCartItemNameView = function (item) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-sc-item-name')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(item.product.name)
			]));
};
var _user$project$Cart_View$shoppingCartItemQuantityView = function (item) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-sc-item-quantity')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
...
var _user$project$Cart_View$shoppingCartItemCustomizationView = function (item) {
	var emailValue = A2(_elm_lang$core$Maybe$withDefault, 'N/A', item.customization.email);
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-sc-item-customization')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Email: ', emailValue))
					]))
			]));
};
var _user$project$Cart_View$shoppingCartItemView = function (item) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-sc-item')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Cart_View$shoppingCartItemQuantityView(item),
				_user$project$Cart_View$shoppingCartItemNameView(item),
				_user$project$Cart_View$shoppingCartItemCustomizationView(item),
				_user$project$Cart_View$shoppingCartRemoveItemView(item)
			]));
};
var _user$project$Cart_View$shoppingCartView = function (cart) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-sc')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Shopping Bag')
					])),
				A2(
				_elm_lang$html$Html$ul,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-sc-items')
					]),
				A2(_elm_lang$core$List$map, _user$project$Cart_View$shoppingCartItemView, cart.items))
			]));
};
var _user$project$Cart_View$checkoutView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-checkout')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Cart_View$shoppingCartView(model.cart),
				_user$project$Cart_View$totalView(model),
				_user$project$Cart_View$purchaseView(model),
				_user$project$Cart_View$loaderView(model)
			]));
};
var _user$project$Cart_View$defaultProductPictureURL = 'https://placeholdit.imgix.net/~text?txtsize=33&txt=Product&w=300&h=300';
var _user$project$Cart_View$getProductPictureURL = function (product) {
	var _p4 = product.pictureURL;
	if (_p4.ctor === 'Just') {
		return _p4._0;
	} else {
		return _user$project$Cart_View$defaultProductPictureURL;
	}
};
var _user$project$Cart_View$productViewInStock = function (product) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-product')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						_user$project$Cart_Types$SelectProduct(product))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('elm-cart-product-image')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_user$project$Cart_View$getProductPictureURL(product))
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('elm-cart-product-name')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('elm-cart-product-price elm-cart-button')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(
								_user$project$Cart_View$formatCurrency(product.price))
							]))
					]))
			]));
};
var _user$project$Cart_View$productViewOutOfStock = function (product) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('OUT OF STOCK')
							]))
					]))
			]));
};
var _user$project$Cart_View$productView = function (product) {
	return product.isInStock ? _user$project$Cart_View$productViewInStock(product) : _user$project$Cart_View$productViewOutOfStock(product);
};
var _user$project$Cart_View$productsView = function (products) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('elm-cart-products row')
					]),
				A2(_elm_lang$core$List$map, _user$project$Cart_View$productView, products))
			]));
};
var _user$project$Cart_View$productListView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Cart_View$productsView(model.availableProducts)
			]));
};
var _user$project$Cart_View$productDetailView = function (model) {
	var _p5 = model.currentProduct;
	if (_p5.ctor === 'Just') {
		var _p6 = _p5._0;
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_user$project$Cart_Types$AddToCart,
						_p6,
						_user$project$Cart_View$getCurrentCustomization(model)))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('elm-cart-product-detail')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('elm-cart-product-detail-name')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('elm-cart-product-detail-image'),
									_elm_lang$html$Html_Attributes$src(
									_user$project$Cart_View$getProductPictureURL(_p6))
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('elm-cart-product-detail-price')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(
									_user$project$Cart_View$formatCurrency(_p6.price))
								])),
							_user$project$Cart_View$productDescriptionView(_p6),
							A2(
							_user$project$Cart_View$customizationFormView,
							_p6,
							_user$project$Cart_View$getCurrentCustomization(model)),
							A2(
							_elm_lang$html$Html$button,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('elm-cart-product-detail-add elm-cart-button'),
									_elm_lang$html$Html_Attributes$type$('submit')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Add To Cart')
								]))
						]))
				]));
	} else {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('There\'s no product')
				]));
	}
};
var _user$project$Cart_View$page = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('elm-cart-page container-fluid')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				function () {
				...
				switch (_p7.ctor) {
					case 'ProductList':
						return _user$project$Cart_View$productListView(model);
					case 'ProductDetail':
						return _user$project$Cart_View$productDetailView(model);
					case 'Checkout':
						return _user$project$Cart_View$checkoutView(model);
					default:
						return _user$project$Cart_View$postCheckoutView(model);
				}
			}()
			]));
};
var _user$project$Cart_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('elm-cart')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Cart_View$headerView(model),
				_user$project$Cart_View$page(model),
				_user$project$Cart_View$footerView(model)
			]));
};

var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Cart_State$init, update: _user$project$Cart_State$update, subscriptions: _user$project$Cart_State$subscriptions, view: _user$project$Cart_View$view})
};
